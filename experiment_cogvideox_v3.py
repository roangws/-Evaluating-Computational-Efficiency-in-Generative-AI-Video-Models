...
PROGRESS_LOG_FILE = "progress_log_v3.txt"
RESULTS_CSV_FILE = "results_v3.csv"
SUMMARY_FILE = "summary_v3.txt"
ERROR_LOG_FILE = "errors_v3.log"
OUTPUT_VIDEO_DIR = "output_videos_cogvideox_v3"
...
def run_experiments():
    ...
    if checkpoint and os.path.exists(RESULTS_CSV_FILE):
        ...
        print("="*60)
        print("COGVIDEOX V3 COST-EFFICIENCY BENCHMARKING EXPERIMENT")
        print("="*60)
...
def calculate_statistics():
    ...
    print("\n" + "="*60)
    print("✓ Results saved to results_v3.csv")
